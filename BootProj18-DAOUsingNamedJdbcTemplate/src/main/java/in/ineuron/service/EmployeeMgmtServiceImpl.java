...
public class EmployeeMgmtServiceImpl implements IEmployeeMgmtService {
	...
	public List<EmployeeDTO> fetchEmployeeByDesg(String desg1, String desg2, String desg3) {
		...
		List<EmployeeBO> employeeBO = dao.fetchEmployeeByDesg(desg1, desg2, desg3);
	...
	public String registerEmployee(EmployeeDTO dto) {
		...
		return dao.registerEmployee(bo) == 1 ? "row inserted successfully" : "record insertion failed";
	}

	@Override
	public String fetchEmployeeByNo(int no) {
		String name = dao.fetchEmployeeByNo(no);
		return name;
	}
